                ...
                <div class="card-body">
                    <div class="info-group">
                        ...
                        <div class="form-group ">
                            ...
                            {{Form::textarea('description',null,array('class'=>'form-control','rows'=>5,'placeholder'=>__('Enter Property Description')))}}
                        </div>
                        <div class="form-group">
                ...
                <div class="card-body">
                    <div class="info-group">
                        ...
                        <div class="form-group ">
                            ...
                            {{Form::textarea('address',null,array('class'=>'form-control','rows'=>1,'placeholder'=>__('Enter Property Address')))}}
                        </div>
                    </div>
                </div>
            </div>
