    ...
    <div class="codex-authbox">
        <div class="auth-header">
            <div class="codex-brand">
                <a href="#">
                    <img class="img-fluid light-logo" src="{{ asset('assets/images/logo/logoK.png') }}" alt="">
                </a>
            </div>
            <h3>{{__('Get started with ')}} {{env('APP_NAME')}}</h3>
        ...
        {{-- <div class="auth-footer">
            ...
            <h6 class="text-center">{{__('Dont have an account?')}} <a class="text-primary" href="{{ route('register') }}">Creat an account</a></h6>
        </div> --}}
    </div>
@endsection
